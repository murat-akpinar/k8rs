...
| `views.rs` | The three views, grouping, sorting — **and, since Phase 11, the wording a detail tab draws**: the event and container sentences the drawn pane and `main.rs`'s headless printer both read, moved down here because `k8s.rs` was already frozen and this file freezes at Phase 11's close ([D254](../NOTES.md#d254--the-events-tab-is-settled-before-it-is-drawn-describes-grammar-reused-whole-a-heading-that-only-comes-back-to-withdraw-a-promise-and-the-check-that-could-not-see-the-defect-it-was-written-after-2026-09-06)) | `dev-ui` | Phase 10 |
