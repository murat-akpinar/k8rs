...
| [Cargo.toml](../Cargo.toml) · [Cargo.lock](../Cargo.lock) | The allowed crates and the pinned graph. A dependency is a recorded decision ([invariant 10](../CLAUDE.md#hard-invariants--never-break-one-without-an-explicit-decision)) | PM only |
...
| `views.rs` | The three views, grouping, sorting — **and, since Phase 11, the wording a detail tab draws**: the event and container sentences the drawn pane and `main.rs`'s headless printer both read, moved down here because `k8s.rs` was already frozen and this file freezes at Phase 11's close ([D254](../NOTES.md#d254--the-events-tab-is-settled-before-it-is-drawn-describes-grammar-reused-whole-a-heading-that-only-comes-back-to-withdraw-a-promise-and-the-check-that-could-not-see-the-defect-it-was-written-after-2026-09-06)) | `dev-ui` | Phase 12 close ([D266](../NOTES.md#d266--the-phase-11-close-six-screens-that-draw-something-false-and-a-freeze-set-one-phase-before-its-consumer-2026-09-13)) |
| `ui.rs` | Drawing, keys, dialogs. A ninth file (`dialog.rs`) is pre-approved if this passes ~800 lines | `dev-ui` | Phase 12 close ([D266](../NOTES.md#d266--the-phase-11-close-six-screens-that-draw-something-false-and-a-freeze-set-one-phase-before-its-consumer-2026-09-13)) |
